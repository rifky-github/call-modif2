...
char = '+62'
if no_telp in char:
    no_telp = no_telp.replace('+62 ', '')
    no_telp = no_telp.split('-')
    no_telp1 = no_telp[0]
    no_telp2 = no_telp[1]
    no_telp3 = no_telp[2]
    no_telp = no_telp1 + no_telp2 + no_telp3
    url = "https://id.jagreward.com/member/verify-mobile/" + no_telp + "/"
...
\033[1;97m
==================================================
Recoder  \033[1;91m:\033[1;96mHayo Siapa\033[1;97m
...
"User-Agent": "Mozilla/5.0 (Linux; Android 9; SM-AW345) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.162 Mobile Safari/537.36",
